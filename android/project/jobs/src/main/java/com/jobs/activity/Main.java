...
public class Main extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer = new DrawerBuilder()
                ...
                .addDrawerItems(
                        new PrimaryDrawerItem().withName("Home").withIcon(R.drawable.icon_user_32),
                        new PrimaryDrawerItem().withName("Edit Profile").withIcon(R.drawable.icon_user_32),
                        new PrimaryDrawerItem().withName("Notifications").withIcon(R.drawable.icon_user_32),
                        new DividerDrawerItem(),
                        new PrimaryDrawerItem().withName("Create Listing").withIcon(R.drawable.icon_user_32),
                        new PrimaryDrawerItem().withName("Active Jobs (TODO)").withIcon(R.drawable.icon_briefcase_32),
                        new PrimaryDrawerItem().withName("Active Listings").withIcon(R.drawable.icon_list_32),
                        new PrimaryDrawerItem().withName("Watchlist (TODO)").withIcon(R.drawable.icon_star_32),
